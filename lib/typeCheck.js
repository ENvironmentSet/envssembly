...
//@param String [s]
///@return boolean is_alphabet
module.exports.is_IdentifilerL = (string) => {
    var reg = /[a-zA-Z|_]/;
    return reg.test(string)?!/[^a-zA-Z|_]+/.test(string) : false;
};
//@param String [s]
...
module.exports.is_Memory_CHAR = (string) => {
    var reg = /\[|\]|\+|-|[a-zA-Z]|[0-9]/;
    return reg.test(string);
};
//@param String [s]
///@return boolean Memory_expression
module.exports.is_MemoryL = (string) => {
    var reg = /\[(\+|-|[a-zA-Z]*|[0-9])*\]/;
    return reg.test(string);
};
//@param String [s]
